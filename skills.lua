		...
		function ()
			...
			gamerun_item = function(i)
				...
				if i == 1 then
					...
					is_drawx = false
				elseif i == 2 then
					add_funcptr(push_message, char_juese[char_current_i].name.."发动了武将技能 '英魂'选择摸"..(char_juese[char_current_i].tili_max-char_juese[char_current_i].tili).."弃1")
					is_drawx = true
				else
					set_hints("")
					gamerun_status = ""
